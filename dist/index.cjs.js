    ...
    return (React__default["default"].createElement(SelectProvider, { otherData: {
        ...
        React__default["default"].createElement("div", { className: "relative w-full", ref: ref },
            React__default["default"].createElement("div", { "aria-expanded": open, onKeyDown: onPressEnterOrSpace, onClick: toggle, className: getSelectClass() },
                React__default["default"].createElement("div", { className: "grow pl-2.5 py-2 pr-2 flex flex-wrap gap-1 overflow-hidden" }, !isMultiple ? (React__default["default"].createElement("p", { className: "truncate cursor-default select-none" }, value && !Array.isArray(value) ? value.label : placeholder)) : (React__default["default"].createElement(React__default["default"].Fragment, null,
            ...
            open && !isDisabled && (React__default["default"].createElement("div", { className: classNames?.menu
                ...
                React__default["default"].createElement(Options, { list: list, noOptionsMessage: noOptionsMessage, text: onSearchInputChange && typeof onSearchInputChange === "function"
                        ? ""
                        : inputValue, isMultiple: isMultiple, value: value, primaryColor: primaryColor || DEFAULT_THEME }))))));
};
